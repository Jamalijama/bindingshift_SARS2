...
with open (model, 'rb') as f:
    ...
    for rand_i in range(0,10,1):
        ...
        # df_array_3 = df_array0[df_array0['label'] == 3].sample(n = 600, random_state = rand_i)
        # df_array_4 = df_array0[df_array0['label'] == 4].sample(n = 600, random_state = rand_i)
        
        # df_array_0 = df_array0[df_array0['label'] == 0].sample(n = 1000, random_state = rand_i)
        # df_array_1 = df_array0[df_array0['label'] == 1].sample(n = 1000, random_state = rand_i)
        # df_array_2 = df_array0[df_array0['label'] == 2].sample(n = 1000, random_state = rand_i)
        # df_array_3 = df_array0[df_array0['label'] == 3].sample(n = 600, random_state = rand_i)
        # df_array_4 = df_array0[df_array0['label'] == 4].sample(n = 600, random_state = rand_i)
