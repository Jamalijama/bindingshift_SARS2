...
for model in model_lst0[5:]:
    ...
    with open (model, 'rb') as f:
        ...
        for rand_i in range(0,10,1):
            ...
            df_label = pd.concat([df_label_0, df_label_1, df_label_2, df_label_3, df_label_4]) 
            ...
            df_tsne.to_csv ('df_tsne_' + file_name + '_sampled_3000_' + str(rand_i) +'_label1.csv')
            df_pca.to_csv ('df_PCA_' + file_name + '_sampled_3000_' + str(rand_i) +'_label1.csv')
