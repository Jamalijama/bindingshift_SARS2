...
df_test = pd.read_csv ('./data/S1psudoviruses.csv', index_col = 'seqID', encoding = 'gbk')

cdslst = df_test['prS1'].tolist()
model_path = "./esm2_SARSMERSfinetuned/" 
...
for m in os.listdir(model_path):
    ...
    len_cds = 256
    pkl_path = './embedding/embedding_S1psudoviruses_SARSMERSesm2/' + m + '_SARSMERSembedding.pkl'
    print (pkl_path)
    embed_lst = []
